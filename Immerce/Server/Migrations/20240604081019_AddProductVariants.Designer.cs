...
namespace Immerce.Server.Migrations
{
    ...
    [Migration("20240604081019_AddProductVariants")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Immerce.Shared.Category", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Immerce.Shared.ProductType", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Immerce.Shared.ProductVariant", b =>
                {
            ...
            modelBuilder.Entity("Immerce.Shared.Product", b =>
                {
                    b.HasOne("Immerce.Shared.Category", "Category")
                        .WithMany()
            ...
            modelBuilder.Entity("Immerce.Shared.ProductVariant", b =>
                {
                    b.HasOne("Immerce.Shared.Product", "Product")
                        .WithMany("Variants")
                        .HasForeignKey("ProductId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("Immerce.Shared.ProductType", "ProductType")
                        .WithMany()
